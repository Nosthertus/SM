...
CREATE TABLE IF NOT EXISTS `SM`.`genderbread` (
  ...
  `genderbread_identity_visibility` ENUM('Public', 'Procted', 'Private') NULL,
  `genderbread_expression` ENUM('1', '2', '3', '4', '5', '6', '7') NULL,
  `genderbread_expression_visibility` ENUM('Public', 'Procted', 'Private') NULL,
  `genderbread_asex` ENUM('1', '2', '3', '4', '5', '6', '7') NOT NULL,
  `genderbread_asex_visibility` ENUM('Public', 'Procted', 'Private') NOT NULL,
  `genderbread_attracted` ENUM('1', '2', '3', '4', '5', '6', '7') NULL,
  `genderbread_attracted_visibility` ENUM('Public', 'Procted', 'Private') NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `SM`.`user` (
  ...
  `genderbread_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `SM`.`accounts` (
  ...
  INDEX `fk_accounts_network1_idx` (`network_id` ASC),
  CONSTRAINT `fk_accounts_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `SM`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_accounts_network1`
...
CREATE TABLE IF NOT EXISTS `SM`.`messages` (
  ...
  `messages_date` TIMESTAMP(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `SM`.`photos` (
  ...
  `photos_caption` BLOB NULL,
  `photos_date` DATETIME NOT NULL,
  `accounts_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `SM`.`user_has_photos` (
  ...
  INDEX `fk_user_has_photos_types1_idx` (`types_id` ASC),
  ...
  CONSTRAINT `fk_user_has_photos_photos1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_photos_types1`
...
CREATE TABLE IF NOT EXISTS `SM`.`user_has_messages` (
  ...
  INDEX `fk_user_has_messages_types1_idx` (`types_id` ASC),
  ...
  CONSTRAINT `fk_user_has_messages_messages1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_messages_types1`
    FOREIGN KEY (`types_id`)
    REFERENCES `SM`.`types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
